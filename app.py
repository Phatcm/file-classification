...
if st.button("Upload and process"):
    ...
    for i, file in enumerate(uploaded_files):
        ...
        if file is not None:
            api_base_url = "https://wwvwkzn4ge.execute-api.ap-northeast-1.amazonaws.com/files"
            api_url = "{}?file_name={}".format(api_base_url, file.name)
            print(api_url)
        ...
        if r.status_code == 204:
            ...
            api_url = "{}?file_metadata={}".format(api_base_url, json.dumps(metadata))
            print(api_url)
